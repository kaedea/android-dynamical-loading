...
package com.yy.mobile.ylink.dynamicload.core;
...
import com.yy.mobile.ylink.dynamicload.*;
...
import com.yy.mobile.ylink.utils.DLConstants;
import com.yy.mobile.ylink.utils.SoLibManager;
...
public class DLPluginManager {
    ...
    private DLPluginPackage pluginPackageCurrent;

    public DLPluginPackage getCurrentPluginPackage() {
    ...
    public Fragment getPluginFragment (Activity activity,DLIntent dlIntent){
        ...
        pluginPackageCurrent = mPackagesHolder.get(packageName);
        if (pluginPackageCurrent == null) {
            return null;
        }

        final String className = dlIntent.getPluginClass();
        Class<?> clazz = loadPluginClass(pluginPackageCurrent.classLoader, className);
        if (clazz == null) {
            return null;
        }
